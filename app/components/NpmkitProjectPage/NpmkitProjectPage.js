    ...
    <Page title="npmkit Project">
        <ContentSection title={<Formatter>Key technologies</Formatter>}>
            <p>
                ...
                <Link to="//github.com/facebook/react" eventLabel="react-link">React</Link> and{' '}
                <Link to="//github.com/reactjs/redux" eventLabel="redux-link">Redux</Link>.
            </p>
        </ContentSection>
        ...
        <ContentSection title={<Formatter>What were planned</Formatter>}>
            ...
            <ul>
                <li>
                    ...
                    <br />
                    <span>
                        List of your projects with quick filter and favorites on top. So you
                        can jump to any project directory in file explorer just in 2 click, hooray!
                    </span>
                </li>
                <li>
                    ...
                    <br />
                    <span>
                        Keeping your dependencies up-to-day in npm is taught. I found this super
                        useful (and hard to implement, too!).
                    </span>
                </li>
                <li>
                    <b>Tasks Status</b>
                ...
                <li>
                    ...
                    <br />
                    <span>
                        This is simple editor for your package.json. It helps to avoid shooting
                        your leg by putting comma at wrong place in file.
                    </span>
                </li>
            </ul>
            <p>
